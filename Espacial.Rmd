...
```{r, warning = FALSE}
Spain <- shapefile("D:/SEMINARIO_BIOGEOGRAFIA/VECTORIAL/SPAIN/spain.shp")
...
**Exportar**
```{r, eval = FALSE}
raster::shapefile(Aragon, "D:/SEMINARIO_BIOGEOGRAFIA/VECTORIAL/Aragon.shp")
```
...
```{r}
Temperatura <- raster("D:/SEMINARIO_BIOGEOGRAFIA/RASTER/Temperatura.tif")
Precipitacion <- raster("D:/SEMINARIO_BIOGEOGRAFIA/RASTER/Precipitacion.tif")
```
...
**Exportar**
```{r, eval = FALSE}
writeRaster(Variable, "D:/SEMINARIO_BIOGEOGRAFIA/RASTER/Variable.tif")
```

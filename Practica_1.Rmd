...
for (i in 1:length(download_chelsa_tasmin)){
  ...
  writeRaster(raster_Aragon,
              paste0(
                "D:/SEMINARIO_BIOGEOGRAFIA/RASTER/",
                str_sub(
...
download.file(XXX,
  ...
  writeRaster(raster_Aragon, "D:/SEMINARIO_BIOGEOGRAFIA/RASTER/XXX")
...
download.file(download_chelsa,
  ...
  writeRaster(raster_Aragon, "D:/SEMINARIO_BIOGEOGRAFIA/RASTER/Practica_1/tmax_aragon_1_2012.tif")
